...
#include "cameraModelCal/camera_models/CataCamera.h"
#include "cameraModelCal/camera_models/ScaramuzzaCamera.h"
#include "cameraModelCal/camera_models/PinholeCamera.h"
#include "cameraModelCal/camera_models/EquidistantCamera.h"
...
CameraFactory::generateCameraFromYamlFile(const std::string& filename)
{
    ...
    if(!fs.isOpened())
    {
        std::cerr << "CameraFactory::generateCameraFromYamlFile: "
                  << "error opening yaml file \"" << filename << "\"" << std::endl;
        return CameraPtr();
    }
